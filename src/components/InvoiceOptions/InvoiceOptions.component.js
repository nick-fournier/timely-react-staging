...
export default function InvoiceOptions({CurrentItem, setsearchField, setSearchMethod, DataSwitch}) {
    ...
    const scheduleInvoice = async () =>{
        ...
        const ScheduleURL = `http://localhost:8000/api/${(DataSwitch === 1 ? 'receivables': 'payables')}/${ScheduledInvoice.invoice_id}/`
    ...
    const flagInvoice = async () =>{
        ...
        const FlagURL = `http://localhost:8000/api/${(DataSwitch === 1 ? 'receivables': 'payables')}/${FlaggedInvoice.invoice_id}/`
    ...
    const markInvoice = async () =>{ 
        ...
        const MarkURL = `http://localhost:8000/api/${(DataSwitch === 1 ? 'receivables': 'payables')}/${MarkedInvoice.invoice_id}/`
